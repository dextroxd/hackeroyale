 ...
 */
public class PasswordCracking extends Fragment {
...
//        }
        ...
        url = "https://www.hackeroyale.com/wp-json/wp/v2/posts?categories=271&page=1";
        getJson(url);
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if(linearLayoutManager.findLastCompletelyVisibleItemPosition()==listModels.size()-1){
                    ...
                    getJson("https://www.hackeroyale.com/wp-json/wp/v2/posts?categories=271&page="+p);
