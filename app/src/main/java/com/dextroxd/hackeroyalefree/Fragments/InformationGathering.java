 ...
 */
public class InformationGathering extends Fragment {
...
//        mExcerpt = new ArrayList<>();
//        mImage = new ArrayList<>();
//        mReadtime = new ArrayList<>();
//        mText = new ArrayList<>();
...
//        }
        ...
        url = "https://www.hackeroyale.com/wp-json/wp/v2/posts?categories=139&page=1";
        getJson(url);
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if(linearLayoutManager.findLastCompletelyVisibleItemPosition()==listModels.size()-1){
                    p++;
                    getJson("https://www.hackeroyale.com/wp-json/wp/v2/posts?categories=139&page="+p);
