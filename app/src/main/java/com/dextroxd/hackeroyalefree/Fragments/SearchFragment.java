...
//        else { getActivity().setTheme(R.style.AppTheme); }
        ...
        imageButton = view.findViewById(R.id.search_bar1);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(getActivity(),"Enter the search keyword",Toast.LENGTH_SHORT).show();
                    return;
                }

                url = "https://www.hackeroyale.com/wp-json/wp/v2/posts?search="+search+"&page=1";
                ...
                recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
                    ...
                    public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                        ...
                        if(linearLayoutManager.findLastCompletelyVisibleItemPosition()==listModels.size()-1){
                            ...
                            getJson("https://www.hackeroyale.com/wp-json/wp/v2/posts?search="+search+"&page="+p);
